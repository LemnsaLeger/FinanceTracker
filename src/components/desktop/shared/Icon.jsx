// src/components/desktop/shared/Icon.jsx
// Inline SVG icon renderer — no external icon library needed.
...
export default function Icon({ name, size = 18, color = "currentColor" }) {
  const icons = {
    ...
    car:            <><path d="M5 17H3a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v9a2 2 0 0 1-2 2h-2"/><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/></>,
